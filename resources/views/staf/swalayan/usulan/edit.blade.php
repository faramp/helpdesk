...
@section('title', 'Revisi Data Usulan')
@section('content')
...
<form action="/staf/usulkan/create" method="post">
          <div class="g-pa-20">
            <h1 class="g-font-weight-300 g-font-size-28 g-color-black g-mb-28">Revisi Data Usulan</h1>
                ...
                <div class="g-brd-around g-brd-gray-light-v7 g-rounded-4 g-pa-15 g-pa-20--md g-mb-30">
                  ...
                  <div class="form-group g-mb-30">
                    ...
                    <div class="form-group u-select--v3 g-pos-rel g-brd-gray-light-v7 g-rounded-4 mb-0">
                      ...
                      <input type="text" name="" value="{{$detail->nama_pekerjaan}}" disabled="">
                    </div>
                  </div>
                  ...
                  <div class="form-group g-mb-30">
                    ...
                    <div class="g-pos-rel">
                      ...
                      <i class="hs-admin-check g-absolute-centered g-font-size-default g-color-lightblue-v3"></i>
                       ...
                       <textarea id="inputGroup-1_3" class="form-control form-control-md u-textarea-expandable g-brd-gray-light-v7 g-brd-gray-light-v3--focus g-rounded-4 g-resize-none g-overflow-hidden" rows="3" name="pesan" placeholder=""></textarea>
                    </div>
                  </div>
