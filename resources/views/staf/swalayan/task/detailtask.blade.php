...
@section('title', 'Detail Data Task')
@section('content')
          ...
          <div class="g-hidden-sm-down g-bg-gray-light-v8 g-pa-20">
            <ul class="u-list-inline g-color-gray-dark-v6">
              ...
              <li class="list-inline-item">
                <span class="g-valign-middle">Detail Data Task</span>
              </li>
            </ul>
          </div>

<form action="/staf/datatask/{{$detail->id}}" method="post">
          <div class="g-pa-20">
            <h1 class="g-font-weight-300 g-font-size-28 g-color-black g-mb-28">Detail Data Task</h1>
