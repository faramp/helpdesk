    ...
    <div class="row no-gutters g-pos-rel g-overflow-x-hidden">
      ...
      <i class="hs-admin-pie-chart"></i>
          ...
          <li class="u-sidebar-navigation-v1-menu-item u-side-nav--has-sub-menu u-side-nav--top-level-menu-item">
            <a class="media u-side-nav--top-level-menu-link u-side-nav--hide-on-hidden g-px-15 g-py-12"  data-hssm-target="#subMenu6">
              <span class="d-flex align-self-center g-pos-rel g-font-size-18 g-mr-18">
      <i class="hs-admin-layout-grid-4-alt"></i>
    </span>
              <span class="media-body align-self-center">Data Master</span>
      ...
      <i class="hs-admin-angle-right"></i>
            ...
            <ul id="subMenu6" class="u-sidebar-navigation-v1-menu u-side-nav--second-level-menu mb-0">
              ...
              <li class="u-sidebar-navigation-v1-menu-item u-side-nav--second-level-menu-item">
                <a class="media u-side-nav--second-level-menu-link g-px-15 g-py-12" href="/kasie/pekerjaan">
                  <span class="d-flex align-self-center g-mr-15 g-mt-minus-1">
          <i class="hs-admin-control-record"></i>
        </span>
                  <span class="media-body align-self-center">Pekerjaan</span>
                </a>
              </li>
              ...
              <!-- Panel with Tabs -->
              <li class="u-sidebar-navigation-v1-menu-item u-side-nav--second-level-menu-item">
                <a class="media u-side-nav--second-level-menu-link g-px-15 g-py-12" href="/kasie/aktifitas">
                  <span class="d-flex align-self-center g-mr-15 g-mt-minus-1">
          <i class="hs-admin-control-record"></i>
        </span>
                  <span class="media-body align-self-center">Aktifitas</span>
                </a>
              </li>

               <li class="u-sidebar-navigation-v1-menu-item u-side-nav--second-level-menu-item">
                <a class="media u-side-nav--second-level-menu-link g-px-15 g-py-12" href="/kasie/unitkerja">
                  <span class="d-flex align-self-center g-mr-15 g-mt-minus-1">
          <i class="hs-admin-control-record"></i>
        </span>
                  <span class="media-body align-self-center">Unit Kerja</span>
                </a>
              </li>
...
<li class="u-sidebar-navigation-v1-menu-item u-side-nav--has-sub-menu u-side-nav--top-level-menu-item">
      ...
      <i class="hs-admin-desktop"></i>
              ...
              <span class="media-body align-self-center">Swalayan</span>
              <span class="d-flex align-self-center u-side-nav--control-icon">
      <i class="hs-admin-angle-right"></i>
    </span>
              <span class="u-side-nav--has-sub-menu__indicator"></span>
