...
@section('title', 'Detail Data Task Saya')
@section('content')
          ...
          <div class="g-hidden-sm-down g-bg-gray-light-v8 g-pa-20">
            <ul class="u-list-inline g-color-gray-dark-v6">
              ...
              <li class="list-inline-item">
                <span class="g-valign-middle">Detail Data Task Saya</span>
              </li>
            </ul>
          </div>

<form action="/kasie/tasksaya/{{$detail->id}}" method="post">
          <div class="g-pa-20">
            <h1 class="g-font-weight-300 g-font-size-28 g-color-black g-mb-28">Detail Data Task Saya</h1>
            ...
            <div class="row">
              ...
              <div class="col-md-6">
                ...
                <div class="g-brd-around g-brd-gray-light-v7 g-rounded-4 g-pa-15 g-pa-20--md g-mb-30">
                  ...
                  <input type="text" name="status" value="{{$detail->status_id}}" hidden>

                  @if($detail->status_id == 7)
                  <div class="form-group g-mb-30">
                  ...
                  @if(($detail->status_id == 4) || ($detail->status_id == 7))
