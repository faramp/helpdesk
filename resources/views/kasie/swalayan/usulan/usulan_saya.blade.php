...
@section('title', 'Data Usulan Saya')
@section('content')
          ...
          <div class="g-hidden-sm-down g-bg-gray-light-v8 g-pa-20">
            <ul class="u-list-inline g-color-gray-dark-v6">
              ...
              <li class="list-inline-item">
                <span class="g-valign-middle">Data Usulan Saya</span>
              </li>
            </ul>
          </div>
          <!-- End Breadcrumb-v1 -->
...
@endif
    ...
    <tr> 
      ...
      <td style="text-align: center">
        <a href="/kasie/usulansaya/{{$du->id}}"><button type="button" class="btn btn-success">Detail</button></a>
      </td>      
    </tr>
    <?php $no++; ?>
    @endforeach
