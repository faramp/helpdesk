  <script type="text/javascript">  $.HSCore.components.HSDatatables.init('.js-datatable');</script>
...
<span class="u-tags-v1 text-center g-width-180 g-brd-around g-brd-lightblue-v3 g-bg-lightblue-v3 g-font-size-default g-color-white g-rounded-50 g-py-4 g-px-15">{{$r->nama_status}}</span>
              ...
              <td style="text-align: center">
                 ...
                 <a href="/kasie/intruksi/detail_izin/{{$r->id}}"><button type="button" class="btn btn-success" title="edit">Detail</button></a>
