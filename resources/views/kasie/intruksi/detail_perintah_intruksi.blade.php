...
<div class="col g-ml-45 g-ml-0--lg g-pb-65--md">
          ...
          <div class="g-hidden-sm-down g-bg-gray-light-v8 g-pa-20">
            <ul class="u-list-inline g-color-gray-dark-v6">
              ...
              <li class="list-inline-item">
                <span class="g-valign-middle">Detail Perintah Intruksi</span>
              </li>
            </ul>
          </div>
 ...
 <div class="g-pa-20">
          ...
          <textarea id="inputGroup-1_1" class="form-control form-control-md g-resize-none g-brd-gray-light-v7 g-brd-gray-light-v3--focus g-rounded-4" rows="3" placeholder="Penjelasan tentang intruksi" name="deskripsi">{{$intruksi->deskripsi}}</textarea>
             ...
             <div class="form-group g-mb-30">
                    <h4 class="h6 g-font-weight-600 g-color-black g-mb-20">Ditugaskan Oleh</h4>
...
<form action="/kasie/intruksi/kumpulkan/{{$intruksi->id}}" method="post">
...
<span class="u-tags-v1 text-center g-width-180 g-brd-around g-brd-lightblue-v3 g-bg-lightblue-v3 g-font-size-default g-color-white g-rounded-50 g-py-4 g-px-15">{{$r->nama}}</span>
 ...
 @if ($intruksi->status_id === 7)
                   <div class="form-group g-mb-30">
           <h4 class="h6 g-font-weight-600 g-color-black g-mb-20">Pesan Revisi</h4>
          <textarea id="inputGroup-1_1" class="form-control form-control-md g-resize-none g-brd-gray-light-v7 g-brd-gray-light-v3--focus g-rounded-4" rows="3" placeholder="Penjelasan tentang intruksi" name="deskripsi">{{$intruksi->pesan}}</textarea>
           </div>
           @endif
