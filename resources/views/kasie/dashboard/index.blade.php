                ...
                <div class="card-block g-font-weight-300 g-pa-20">
                  <div class="media">
                    ...
                    <div class="media-body align-self-center">
                      ...
                      <h6 class="g-font-size-16 g-font-weight-300 g-color-gray-dark-v6 mb-0">Usulan Pekerjaan</h6>
                    </div>
                  </div>
                </div>
              </div>
                ...
                <div class="card-block g-font-weight-300 g-pa-20">
                  <div class="media">
                    ...
                    <div class="media-body align-self-center">
                      ...
                      <h6 class="g-font-size-16 g-font-weight-300 g-color-gray-dark-v6 mb-0">Usulan Aktivitas</h6>
                    </div>
                  </div>
                </div>
              </div>
                ...
                <div class="card-block g-font-weight-300 g-pa-20">
                  <div class="media">
                    ...
                    <div class="media-body align-self-center">
                      ...
                      <h6 class="g-font-size-16 g-font-weight-300 g-color-gray-dark-v6 mb-0">Usulan Task</h6>
                    </div>
                  </div>
                </div>
              </div>
                ...
                <div class="card-block g-font-weight-300 g-pa-20">
                  <div class="media">
                    ...
                    <div class="media-body align-self-center">
                      ...
                      <h6 class="g-font-size-16 g-font-weight-300 g-color-gray-dark-v6 mb-0">Penilaian Task</h6>
                    </div>
                  </div>
                </div>
              </div>
