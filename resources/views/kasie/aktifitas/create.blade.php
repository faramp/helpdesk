          ...
          <div class="g-hidden-sm-down g-bg-gray-light-v8 g-pa-20">
            <ul class="u-list-inline g-color-gray-dark-v6">
              ...
              <li class="list-inline-item">
                <span class="g-valign-middle">Tambah Aktiftias</span>
              </li>
            </ul>
          </div>

<form action="/kasie/aktifitas" method="post">
          <div class="g-pa-20">
            <h1 class="g-font-weight-300 g-font-size-28 g-color-black g-mb-28">Tambah Aktifitas</h1>
              ...
              <div class="col-md-6">
                ...
                <div class="g-brd-around g-brd-gray-light-v7 g-rounded-4 g-pa-15 g-pa-20--md g-mb-30">
                  ...
                  <div class="form-group g-mb-30">
                    <label class="g-mb-10" for="inputGroup-1_1">Nama Aktifitas</label>
                   ...
                   <div class="g-mb-30">
                    ...
                    <div class="form-group u-select--v3 g-pos-rel g-brd-gray-light-v7 g-rounded-4 mb-0">
                      <select class="js-select u-select--v3-select u-sibling w-100" name="pekerjaan_id" required="required" title="Pilih Pekerjaan" style="display: none;">
